...
{
    [TestFixture]
    internal class SkeinTests
    {
        [Test]
        public void TestSkein256Init()
        {
            var skein = new Skein(256, 256);
            byte[] message = {0xFF};
            byte[] hash1 = skein.ComputeHash(message);
            byte[] hash2 = skein.ComputeHash(message);
            Assert.AreEqual(hash1, hash2);
        }

        // Test vectors from Appendix C of Skein 1.3 paper
        [Test]
        public void TestSkein256X1()
        {
            var skein = new Skein(256, 256);
            byte[] goodHash =
            {
            ...
            byte[] message = {0xFF};
            byte[] hash = skein.ComputeHash(message);
            Assert.AreEqual(goodHash, hash);
        }

        [Test]
        public void TestSkein256X2()
        {
            var skein = new Skein(256, 256);
            byte[] goodHash = {
